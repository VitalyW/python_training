...
class GroupHelper:
    ...
    def return_to_groups_page(self):
        wd = self.app.wd
        if not (wd.current_url.endswith("/group.php") and wd.find_element_by_css_selector("[id='content'] h1").text == "Groups"):
    ...
    def get_group_list(self):
        if self.group_cache is None:
            ...
            for element in wd.find_elements_by_css_selector("span.group"):
                text = element.text
                id = element.find_element_by_css_selector("[name='selected[]']").get_attribute("value")
